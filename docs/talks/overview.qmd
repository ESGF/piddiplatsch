---
title: Piddiplatsch
subtitle: Persistent identifiers for ESGF publication records
---
...
- Connects the ESGF publication stream to persistent identifier services.
...
::: {.flow aria-label="Kafka events flow through project mapping and Handle JSONL to the Handle Service"}
::: {.stage}
**Kafka**
